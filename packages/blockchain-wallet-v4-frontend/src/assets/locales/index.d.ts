...
type MessagesType = {
  ...
  'buttons.send': 'Send'
  'buttons.show': 'Show'
  'buttons.show_me_how': 'Show me how.'
  'buttons.swap': 'Swap'
  ...
  'copy.date': 'Date'
  'copy.explorer.features': 'Explore network stats, charts, prices and more.'
  'copy.failed': 'Failed'
  'copy.from': 'From'
  'copy.from:': 'From:'
  'copy.here': 'here'
  'copy.identity_verification.buy_swap': 'Verify your identity to start buying and swapping crypto.'
  'copy.identity_verification.continue_to_gold': 'Continue with your identity verification to start buying, borrowing, and earning interest.'
  'copy.identity_verification.pending': 'Pending KYC'
  'copy.identity_verification.problem': 'There was a problem verifying your identity.'
  'copy.identity_verification.failed': 'Identity Verification Failed'
  'copy.identity_verification.upgrade_to_gold': 'Upgrade to Gold'
  'copy.interest.earned': 'Interest Earned'
  'copy.learn_more.contact_support': 'Visit our learning area or contact support with our chat widget on the right hand side.'
